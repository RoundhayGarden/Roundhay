...
export default function SearchResults() {
  ...
  useEffect(() => {
    if (debouncedQuery) {
      ...
      Promise.all([searchMovies(debouncedQuery), searchTv(debouncedQuery)])
        ...
        <div className="max-w-3xl mx-auto relative">
          ...
          >
            <Search
              ...
              size={20}
              style={{
                color: isFocused ? "var(--accent)" : "var(--muted-foreground)",
              }}
            />
            <input
              ref={inputRef}
            ...
            >
              ...
              {searchHistory.map((q) => (
                <div
                  ...
                  onMouseEnter={(e) =>
                    (e.currentTarget.style.background = "var(--movie-accent)")
                  }
                  onMouseLeave={(e) =>
        ...
        <div className="flex flex-col items-center justify-center py-24 gap-6 text-center px-4">
          ...
          <div>
            ...
            <p
              ...
              style={{ color: "var(--muted-foreground)" }}
            >
              Type a movie title, series name, or actor to discover amazing
              content
            </p>
          </div>
