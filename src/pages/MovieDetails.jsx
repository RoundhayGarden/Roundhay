...
import { getMovieDetails, getMovieVideos, TMDB_IMAGE_BASE_URL } from "../services/tmdb"
...
const MovieDetails = () => {
  ...
  useEffect(() => {
    ...
    const loadMovieDetails = async () => {
      ...
      try {
        const [details, videos] = await Promise.all([getMovieDetails(id), getMovieVideos(id)])
