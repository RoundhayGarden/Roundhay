        ...
        {showGenreTabs && (
          <div className="flex items-center gap-2 mb-6 flex-wrap">
            ...
            <button
              ...
              className={cn("genre-pill", activeGenre === null && "active")}
            >
              All
            </button>
            ...
            <div className="hidden md:flex items-center gap-1 ml-auto">
              ...
              <Button
                ...
                size="icon-sm"
                onClick={() =>
                  setGenreTabPage((p) => Math.min(totalPages - 1, p + 1))
                }
...
function MovieCard({ movie }) {
  ...
  return (
    ...
    >
      ...
      <div className="p-3">
        <h2 className="line-clamp-1 min-h-[20px] text-sm font-medium text-card-foreground">
          {title}
        </h2>
        <p className="mt-1 line-clamp-1 min-h-[16px] text-xs text-muted-foreground">
          {releaseDate}
        </p>
      </div>
    </article>
